...
public final class CompareFormulaWithLT extends TextOutput implements Exploration {
  ...
  public static void main(String[] args) {
    Exploration velocity = new CompareFormulaWithLT();
    velocity.explore();
  }
  ...
  private void formula(double boost_speed, Velocity v) {
    ...
    Velocity boost = Velocity.of(boost_speed, X);
  ...
  private void lorentzTransformation(double boost_speed, Velocity v) {
    ...
    Velocity boost_v = Velocity.of(boost_speed, X);
    ...
    FourDelta displacement_Kp = FourDelta.of(a_Kp, b_Kp);
