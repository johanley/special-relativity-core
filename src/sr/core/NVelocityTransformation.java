...
*/ 
public final class NVelocityTransformation {
  ...
  */
  public static NVelocity primedVelocity(NVelocity boost_v, NVelocity object_v) {
    return transform(boost_v, object_v, NSense.Primed);
  }
  ...
  */
  public static NVelocity unprimedVelocity(NVelocity boost_v, NVelocity object_v_prime) {
    return transform(boost_v, object_v_prime, NSense.Unprimed);
  }
  ...
  */
  private static NVelocity transform(NVelocity boost_v, NVelocity u, NSense sense) {
    check(boost_v);
