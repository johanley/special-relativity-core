...
/** 
 Find the λ value (usually a ct-coordinate) along a {@link NTimelikeHistory} for which the corresponding event satisfies a given criterion.
...
public final class NFindEvent {
  ...
  */
  public NFindEvent(NTimelikeHistory history, Function<NEvent, Double> criterion, Double epsilon) {
  ...
  /** Call {@link #NFindEvent(NTimelikeHistory, Function, Double)} with epsilon equal to {@link #EPSILON}. */
  public NFindEvent(NTimelikeHistory history, Function<NEvent, Double> criterion) {
  ...
  */
  ...
  private Function<NEvent, Double> criterion;
