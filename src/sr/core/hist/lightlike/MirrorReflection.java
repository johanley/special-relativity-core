...
public final class MirrorReflection implements History {
  ...
  */
  public static MirrorReflection of(DeltaBase deltaBase, NDirection direction) {
  ...
  private MirrorReflection(DeltaBase deltaBase, NDirection direction) {
    this.stitchedHistory = stitchedHistory(deltaBase, direction);
  }
  
  private History stitchedHistory(DeltaBase deltaBase, NDirection direction) {
    MoveableHistory leg1 = PhotonStraight.of(deltaBase, direction);
    MoveableHistory leg2 = PhotonStraight.of(deltaBase, NDirection.of(direction.times(-1)));
