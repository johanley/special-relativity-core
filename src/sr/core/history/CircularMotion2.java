...
*/
public class CircularMotion2 extends MoveableHistory {
  ...
  */
  private CircularMotion2(DeltaBase deltaBase, double radius, double β, Axis rotationalAxis, double initialPhase) {
    super(deltaBase);
